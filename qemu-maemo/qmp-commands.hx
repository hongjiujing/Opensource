...
-> { "execute": "zoom", "arguments": { "level" : 42 } }
<- { "return": {} }
...
-> { "execute": "rct", "arguments": { "state" : "off" } }
<- { "return": {} }
...
- "skin_id": id of current skin (json-string)

Example:

-> { "execute": "query-skin_id" }
<- {
      "return":{
         "skin_id":"skin"
      }
...
- "rotate": is rotated (json-string)

Example:

-> { "execute": "query-rotate" }
<- {
      "return":{
         "rotate":"off"
      }
...
- "keyboard": is visible (json-string)

Example:

-> { "execute": "query-keyboard" }
<- {
      "return":{
         "keyboard":"on"
      }
